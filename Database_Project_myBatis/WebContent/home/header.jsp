					...
					<ul>
						...
						<li class="has-dropdown">
							...
							<ul class="dropdown">
								...
								<hr>
								<li><a href="<%=contextPath %>/basket/myOrder.jsp">주문내역</a></li>
								<li><a href="<%=contextPath %>/userInfo/userInfo.jsp">프로필</a></li>
								<li><a href="<%=contextPath %>/basket/basket.jsp">장바구니</a></li>
						...
						%>
							<li class="has-dropdown">
							<a href="#"><b style="color:white;">관리자 페이지</b></a>
							<ul class="dropdown">
								<li><a href="<%=contextPath %>/admin/orderManagement.jsp">주문관리</a></li>
								<li><a href="<%=contextPath %>/admin/allMember.jsp">회원조회</a></li>
								<li><a href="<%=contextPath %>/home/product.jsp">상품등록</a></li>
							</ul>
						</li>
						<%} %>
					</ul>
...
<%
	String customer_id_HEAD = "NonUser";
	if(customerInfoHeader != null){
